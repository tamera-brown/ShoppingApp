...
customerRoutes.route('/admin/customers').get(function (req, res) {  
...
// Defined edit route  
customerRoutes.route('admin/edit/:id').get(function (req, res) {  
...
customerRoutes.route('admin/update/:id').post(function (req, res) {  
  Customer.findById(req.params.id, function(err, customer) {  
    if (!customer)  
      res.status(404).send("Record not found");  
    else {  
      customer.CustomerUsername = req.body.CustomerUsername;  
...
customerRoutes.route('admin/delete/:id').get(function (req, res) {  
